...
# 最新版本 2.0.5.1 —— 更新时间：2025年3月17日15点53分
...
4. 出于安全的考虑，Android 系统对应用程序直接解锁屏幕的能力进行了严格的限制。通常情况下，应用程序不能直接解锁屏幕，但可以唤醒设备并显示锁屏界面。
5. **最后，在使用本软件之前，最好先自行测试几天，稳定确认没问题之后再使用，谢谢理解！**

# 注意！！！

#### [DT_20250317_2.0.5.1.apk，适合Android 8+系统](apk/daily/release/DT_20250317_2.0.5.1.apk)

1. 升级AGP，提升targetSdk到36（Android 15），适配Android 15版本新特性
2. 更改数据持久化框架，使用官方Room框架

[//]: # (重构应用主题样式，统一使用Material风格)
[//]: # (调整任务列表样式，优化显示效果)
