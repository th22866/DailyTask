...
AutoDingDing（任务精灵）的升级版，相比于之前的版本，做了很多功能提升，但同样也做了版本兼容性调整，`此版本不再兼容8.0以下的系统`
...
# 最新版本 2.0.4 —— 更新时间：2025年3月13日10点06分
...
#### [DT_20250313_2.0.4.apk，适合Android 8+系统](apk/daily/release/DT_20250313_2.0.4.apk)

1. 添加远程启动和停止每日任务功能（`此功能必须开启通知监听，否则指令无效`）。开始每日任务指令：`启动`
   。停止每日任务指令：`停止`。
2. 修复部分手机打完卡状态栏常亮问题
3. 日常更新
